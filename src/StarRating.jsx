    ...
    <div style={containerStyle}>
      <div style={starContainerStyle}>
        {Array.from({ length: maxStarts }, (_, i) => (
          <Star key={i} onRate={() => rateHandler(i + 1)} full={rating >= i + 1} onHoverIn={()=>setTempRating(i+1)} onHoverOut={()=>setTempRating(0)}/>
        ))}
      </div>
...
function Star({ onRate, full }) {
  return (
    <span style={starStyle} onClick={onRate} onMouseEnter={()=>}>
      {full ? (
